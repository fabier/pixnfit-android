 ...
 */
public class GetUserHelpPostAsyncTask extends WsGetAsyncTask<User, Post, List<Post>> {

    public GetUserHelpPostAsyncTask(Context context) {
        super(context);
    }
    ...
    protected String getUrl(User... params) {
        User user = params[0];
        return String.format(Locale.ENGLISH, "/users/%d/posts/help", user.id);
    }
